...
\section{Skills}
\cvcomputer{general}{software engineering, web development, business analysis, consulting, facilitating, teaching}{software engineering}{architecture, full-stack, backend, APIs: SOAP, REST, GraphQL, other, frontend, low-level design, coding, debugging, testing, tool chains}
