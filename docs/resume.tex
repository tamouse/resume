...
\section{Skills}
\cvcomputer{general}{software engineering, web development, dev-ops, business analysis, consulting, facilitating, teaching}{software engineering}{architecture, full-stack, backend, APIs, frontend, low-level design, coding, debugging, testing, tool chains}
\cvcomputer{web frameworks}{Rails, Sinatra, Django, Flask}{web libraries}{jQuery, React, Redux, GraphQL, Apollo, Angular (1.x), Bootstrap, Knockout, Backbone}
...
\cvcomputer{servers}{nginx, unicorn, puma, Apache, lighttpd}{tools}{Emacs, Webstorm, RubyMine, bundler, rake, webpack, babel, npm, gulp, make}
...
\cventry{2001-Present}{Web Developer}{Tamara Temple Web Development (Pontiki Software Crafts)}{Mendota Heights, Minnesota}{}{%
