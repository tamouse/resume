...
design, development and deployment tools and methodologies, especially related to the disciplines of web
...
\cvcomputer{Languages}{Ruby, JavaScript, Python 3, Shell, CSS3, SCSS/SASS, HTML5, PHP, Perl}{Aws}{S3, ECS, EC2, DynamoDB, RDS, Elasticache, Lambda, IAM, Amazon MemoryDB for Redis, CloudFront, Route 53, API Gateway, CodeBuild, CloudWatch, KMS, Secrets}
\cvcomputer{Servers}{Netlify, nginx}{Tools}{Emacs and Org-mode, RubyMine, Webstorm, rake, Thor, make, Node.js, webpack, babel, npm/npx, Storybook, yeoman (yo), Miro, Notion}
\cvcomputer{Testing}{Minitest, RSpec, Jest, Testing Library}{}{}
